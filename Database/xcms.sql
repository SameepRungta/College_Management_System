...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2023 at 06:48 PM
...
('B.A. Eco H', 'Bachelor of Arts Honours in Economics', 'Years', 3),
('B.A. Eng H', 'Bachelor of Arts Honours in English', 'Years', 3),
('B.A. Pass ', 'Bachelor of Arts in Pass Course', 'Years', 3),
('B.A. Pol S', 'Bachelor of Arts in Political Science', 'Years', 3),
('B.A. Psy h', 'Bachelor of Arts Honours in Psychology', 'Years', 3),
('B.Com', 'Bachelor of Commerce', 'Years', 3),
('BBA', 'Bachelor of Business Administration', 'Years', 3),
('BCA', 'Bachelor of Computer Application', 'Years', 3),
('BSc', 'Bachelor of Science', 'Years', 3),
('M.Com', 'Master of Commerce', 'Years', 2),
('MBA', 'Master of Business Administration', 'Years', 2),
('MCA', 'Master of Computer Application', 'Years', 2);
...
('301', 'DATA STRUCTURE AND ALGORITHM (USING C/C++)(TH)', 'BCA', 3, 5),
('302', 'SYSTEM DESIGN CONCEPTS (TH)', 'BCA', 3, 5),
('303', 'NETWORK TECHNOLOGIES (TH)', 'BCA', 3, 5),
('304', 'CORE JAVA PROGRAMMING (TH)', 'BCA', 3, 5),
('305', 'E-COMMERCE (TH)', 'BCA', 3, 5),
('306 B', 'PHP (TH)', 'BCA', 3, 5),
('306 C', 'LINUX (TH)', 'BCA', 3, 5),
('307', 'NETWORKING LABORATORY (PR)', 'BCA', 3, 5),
('308', 'JAVA LABORATORY (PR)', 'BCA', 3, 5),
('309 B', 'PHP LAB (PR)', 'BCA', 3, 5),
('309 C', 'LINUX LAB (PR)', 'BCA', 3, 5),
('310', 'PROJECT (PR)', 'BCA', 3, 5),
('ABST I', 'CORPORATE AND FINANCIAL ACCOUNTING (TH)', 'B.Com', 1, 3),
('ABST II', 'BUSINESS STATISTICS (TH)', 'B.Com', 1, 3),
('BADM I', 'INDIAN FINANCIAL SYSTEM (TH)', 'B.Com', 1, 3),
('BADM II', 'ENTREPRENEURSHIP & SMALL BUSINESS MANAGEMENT (TH)', 'B.Com', 1, 3),
('CP II', 'GENERAL HINDI (TH)', 'B.Com', 1, 3),
('CP III', 'ENVIRONMENT SCIENCE (TH)', 'B.Com', 1, 3),
('CP IV', 'ELEMENTARY COMPUTER APPLICATION (TH)', 'B.Com', 1, 3),
('CP IV PR', 'ELEMENTARY COMPUTER APPLICATION (PR)', 'B.Com', 1, 3),
('EAFM I', 'BUSINESS ECONOMICS (TH)', 'B.Com', 1, 3),
('EAFM II', 'INDIAN FINANCIAL SYSTEM (TH)', 'B.Com', 1, 3),
('PAPER 1', 'INCOME TAX (TH)', 'B.Com', 2, 3),
('PAPER 2', 'COST ACCOUNTING (TH)', 'B.Com', 2, 3),
('PAPER 3', 'ECONOMIC ENVIRONMENT IN RAJASTHAN (TH)', 'B.Com', 2, 3),
('PAPER 4', 'ELEMENTS OF FINANCIAL MANAGEMENT (TH)', 'B.Com', 2, 3),
('PAPER 5', 'COMPANY LAW AND SECRETARIAL PRACTICE (TH)', 'B.Com', 2, 3),
('PAPER 6', 'MANAGEMENT (TH)', 'B.Com', 2, 3);
...
(1, 'admin123', '123', 'Admin', ''),
(5, 'staff123', '123', 'Teacher', 'Activate'),
(6, 'singhenosh5@gmail.com', 'student123', 'Student', 'Activate'),
(7, 'doglover@gmail.com', 'teacher123', 'Teacher', 'Activate'),
(8, 'jithinjoy913@gmail.com', 'student123', 'Student', 'Activate');
...
(20, '2020-21', '2020-06-30 18:30:00'),
(21, '2021-22', '2021-06-30 18:30:00'),
(22, '2022-23', '2022-06-30 18:30:00'),
(23, '2023-24', '2023-06-30 18:30:00');
...
(7, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(8, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(9, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(10, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(11, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(12, 'B.Com', 2, '1', 'PAPER', '', '28-03-23'),
(13, 'BCA', 3, '2', '301', '', '30-03-23'),
(14, 'BCA', 3, '2', '302', '', '30-03-23'),
(15, 'BCA', 3, '2', '303', '', '30-03-23'),
(16, 'BCA', 3, '2', '304', '', '30-03-23'),
(17, 'BCA', 3, '2', '305', '', '30-03-23'),
(18, 'BCA', 3, '2', '306', '', '30-03-23'),
(19, 'BCA', 3, '2', '306', '', '30-03-23'),
(20, 'BCA', 3, '2', '307', '', '30-03-23'),
(21, 'BCA', 3, '2', '308', '', '30-03-23'),
(22, 'BCA', 3, '2', '309', '', '30-03-23'),
(23, 'BCA', 3, '2', '309', '', '30-03-23'),
(24, 'BCA', 3, '2', '310', '', '30-03-23');
...
(4, '2', 5000, '2023-03-30 15:13:19', 'Due'),
(5, '2', 4000, '2023-03-30 15:14:01', 'Paid');
...
('1', 'ENOSH', 'LAWRANCE', 'SINGH', 'RANVEER SINGH', 'singhenosh5@gmail.com', 2147483647, 'B.Com', '2021-22', 'DSC_3455.JPG', 'Yes', 'Yes', '', 'Admitted', 'Approved', '', '2004-11-11', '', 'Male', '', '', 'LALTIPUR,UTTAR PRADESH', '', '', '', '', '', '', '', '', '', 2, 1000, 900, 'UTTAR PRADESH', '2021-06-30 18:30:00'),
('2', 'JITHIN', '', 'JOY', 'K O JOY', 'jithinjoy913@gmail.com', 2147483647, 'BCA', '2020-21', 'IMG_20210102_0001.jpg', 'Yes', 'Yes', '', 'Admitted', 'Approved', '', '2000-07-25', '', 'Male', 'jessy ps,village post-Jiliya,Nagaur,Rajasthan', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, '', '2020-09-30 18:30:00');
...
(3, 'JOHN', ' ', 'WICK', '', 'doglover@gmail.com', '6547854287', 0x6a6f686e2e6a7067, 'Contract', 'Yes', '', '1964-09-02', 0, 'Male', 'NEW YORK CITY', 'NEW YORK CITY', 'Padhorje, Byelorussian SSR, Soviet Union', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '28-03-23');
...
--
ALTER TABLE `student_courses`
  MODIFY `student_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
