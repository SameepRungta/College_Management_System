								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="number" name="mobile_no" class="form-control" required pattern="^[6-9]\d{9}$">
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
													...
													<div class="modal-body">
														<form action="student.php" method="POST" enctype="multipart/form-data">
															<div class="row mt-3">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label for="exampleInputPassword1" required>Enter Semester/Year:*</label>
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,middle_name,admission_date,last_name,email,session,roll_no,form_b ,profile_image,course_code from student_info";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
